...
python $PYTHON_DIR/append_lexicon.py \
  ...
  --numeral_lexicon_base_location $APP_HOME/nsc_dict_data/local/dict/numeral_lexicon_base.bsv \
  --k $K \
  --numeral_lexicon_dumb_location $APP_HOME/nsc_dict_data/local/dict/numeral_lexicon_dumb.tsv \
  --output_lexicon_location $APP_HOME/nsc_dict_data/local/dict/lexicon.txt
