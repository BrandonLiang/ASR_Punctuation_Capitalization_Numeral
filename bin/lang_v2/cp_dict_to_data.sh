...
rm -fr $KALDI_DATA_LOCATION_TOKENZIED/local/*
mkdir -p $KALDI_DATA_LOCATION_TOKENZIED/local/
cp -r $APP_HOME/nsc_dict_data/local/dict_v2 $KALDI_DATA_LOCATION_TOKENZIED/local/dict
