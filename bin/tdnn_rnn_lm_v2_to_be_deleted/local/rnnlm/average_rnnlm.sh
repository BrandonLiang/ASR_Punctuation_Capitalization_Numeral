...
rnnlm_dir=$KALDI_MODEL_LOCATION_TOKENIZED/rnnlm_lstm_tdnn_a
begin=
end=

. $KALDI_TEDLIUM/utils/parse_options.sh # accept options

# get the best iteration
best_iter=$($KALDI_TEDLIUM/rnnlm/get_best_model.py $rnnlm_dir)
...
$KALDI_ROOT/src/nnet3bin/nnet3-average $models ${rnnlm_dir}_averaged/final.raw
$KALDI_ROOT/src/bin/matrix-sum --average=true $embeddings ${rnnlm_dir}_averaged/feat_embedding.final.mat
