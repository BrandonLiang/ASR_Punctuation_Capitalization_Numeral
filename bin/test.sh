...
# decode the lattices
mkdir -p $PREDICTION
$KALDI_ROOT/src/latbin/lattice-best-path ark:'gunzip -c $KALDI_MODEL_LOCATION/$MODEL_DIR/decode_test/lat.*.gz |' 'ark,t:|int2sym.pl -f 2- $KALDI_MODEL_LOCATION/$MODEL_DIR/graph/words.txt > $PREDICTION/decoded_text_$MODEL_DIR.txt'
