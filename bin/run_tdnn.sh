...
TRAIN_STAGE=0 # training stage within TDNN train.py - needs to be lower than -6 to begin with!
TDNN_STAGE=18 # stage in local/chain/run_tdnn.sh - finished all IVector training & extraction
