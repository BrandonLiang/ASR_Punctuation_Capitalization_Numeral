...
$KALDI_TEDLIUM/utils/subset_data_dir.sh \
  --first $KALDI_DATA_LOCATION_TOKENIZED/train \
  10000 \
  $KALDI_DATA_LOCATION_TOKENIZED/train_10k
...
$KALDI_TEDLIUM/steps/train_mono.sh \
  ...
  $KALDI_MODEL_LOCATION_TOKENIZED/mono_10k
...
$KALDI_TEDLIUM/steps/align_si.sh \
  ...
  $KALDI_DATA_LOCATION_TOKENIZED/lang \
  $KALDI_MODEL_LOCATION_TOKENIZED/mono_10k \
  $KALDI_MODEL_LOCATION_TOKENIZED/mono_ali || exit 1;
