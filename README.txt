...
List of Directories and Executables:
    ...
    ./exp_v2/ - directory for Version 2 Kaldi model artifacts
        tri4a_ali/ - GMM-HMM Model (Monophone + Triphone) Graph, Model, Decoding & Scoring Results on dev & test
            decode_dev/
            decode_dev.si/
            decode_dev_rescore/
            decode_test/
            ...
            graph/
            final.mdl
        chain/tdnn1d_sp/ - TDNN Model Graph, Model, Decoding & Scoring Results on dev & test
            decode_dev/
            decode_dev_rescore/
            decode_test/
            decode_test_rescore/
...
Test Script
    ...
    The current configuration decodes the test lattice of TDNN model for Version 2. To change model, see $MODEL_DIR in ./bin/test.sh. To change model version, see $VERSION in ./conf/env.sh.
